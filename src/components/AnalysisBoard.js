...
export const AnalysisBoard = () => {
  ...
  return (
    <ul className='analysis-container'>
      <li className='lines'><span className='caps' style={analysis[0]?.cp / 100 > 0 ? { background: 'white', color: 'black' } : { background: 'black' }}>
        {analysis !== '...'
      ...
      <li className='lines'><span className='caps' style={analysis[1]?.cp / 100 > 0 ? { background: 'white', color: 'black' } : { background: 'black' }}>
        {analysis !== '...'
      ...
      <li className='lines'><span className='caps' style={analysis[2]?.cp / 100 > 0 ? { background: 'white', color: 'black' } : { background: 'black' }}>
        {analysis !== '...'
